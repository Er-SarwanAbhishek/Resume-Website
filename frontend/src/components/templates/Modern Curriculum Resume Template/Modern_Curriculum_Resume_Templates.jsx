...
export default function Moder_Curriculum_Resume_Templates({ resumeData }) {
  ...
  return (
    <div
      className="modern-curriculum-resume-templates"
      style={{
      ...
      <div className="personal-details">
        ...
        <div className="name-section">
          <div className="personal-section  personal-edit">
            <h1 style={{ fontFamily: resumeData.headingTextFont }}>
              {resumeData.userName}
            </h1>
            <h4 style={{ fontFamily: resumeData.headingTextFont }}>
            ...
            <div className="skills-section common-sec skill-edit">
              ...
              <ul>
                {AllSections[3].list.map((skill) => {
                  ...
                  return (
                    <li key={listId} style={paraStyleCSS}>
                      {skillName}
                    </li>
                  );
                })}
              ...
              {AllSections[4].list.map((jobexp) => {
                ...
                return (
                  <div className="each-module" key={listId}>
                    ...
                    <p style={{ ...paraStyleCSS, marginBottom: "3px" }}>
                      <b>{jobRole}</b>
                    </p>
                    <p
                      style={paraStyleCSS}
